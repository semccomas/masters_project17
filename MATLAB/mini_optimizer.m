...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
options = optimoptions(@fmincon,'MaxIterations', 30000, 'MaxFunctionEvaluations',300000, 'OptimalityTolerance', 1.0000e-12, 'StepTolerance', 1.0e-7, 'Display','iter', 'PlotFcn', @optimplotstepsize) ;
